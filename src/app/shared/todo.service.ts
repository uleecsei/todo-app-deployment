...
export class TodoService {
  ...
  fetchTodos(): Observable<Tasks[]> {
    return this.http.get<Tasks[]>('https://todo-app-fe-studying.herokuapp.com/api/todos').pipe(
  ...
  postTodo(task: Tasks): Observable<any> {
    return this.http.post('https://todo-app-fe-studying.herokuapp.com/api/todos', task);
  }
  updateTodo(id: number, title: string): Observable<any> {
    return this.http.post('https://todo-app-fe-studying.herokuapp.com/api/todos/' + id, {title});
  }
  deleteTodo(id: number):Observable<any> {
    return this.http.delete('https://todo-app-fe-studying.herokuapp.com/api/todos/' + id);
  }
